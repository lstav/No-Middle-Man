...
{  
  ...
  if($count > 0)
  {
	  ...
	  $youtube = $row['Youtube'];
	  if($youtube !== '')
	  $youtubeLink = '<a title="Lorem ipsum" target="_blank" href="'.$youtube.'"><img src="images/YouTube-social-squircle_red_48px.png" alt="Lorem ipsum"></a>';
	  
	  $facebook = $row['Facebook'];
	  if($facebook !=='')
	  $facebookLink = '<a title="Lorem ipsum" target="_blank" href="'.$facebook.'"><img src="images/fb-48px.png" alt="Lorem ipsum"></a>';
	  
	  $instagram = $row['Instagram'];
	  if($instagram !=='')
	  $instagramLink = '<a title="Lorem ipsum" target="_blank" href="'.$instagram.'"><img src="images/Instagram.png" alt="Lorem ipsum"></a>';
      
	  $twitter = $row['Twitter'];
	  if($twitter !=='')
	  $twitterLink = '<a title="Lorem ipsum" target="_blank" href="'.$twitter.'"><img src="images/Twitter.png" alt="Lorem ipsum"></a>'  ;    
